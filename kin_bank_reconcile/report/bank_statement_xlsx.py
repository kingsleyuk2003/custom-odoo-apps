...
class BankStatement(ReportXlsx):
    ...
    def generate_xlsx_report(self, workbook, data, objects):
        ...
        for line in obj.move_line_ids :
            report_worksheet.write(row, 0,  datetime.strptime(line.date, '%Y-%m-%d').strftime('%d/%m/%Y'), cell_wrap_format)
...
BankStatement('report.kin_bank_reconcile.report_bank_statement_excel','bank.statement.wizard')
